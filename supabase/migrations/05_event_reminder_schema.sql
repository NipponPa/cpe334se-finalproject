...
COMMENT ON COLUMN public.events.reminder_minutes IS 'Number of minutes before the event start time to send a reminder notification. NULL means no reminder.';uuu